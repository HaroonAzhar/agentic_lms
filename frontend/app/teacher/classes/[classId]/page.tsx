                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                            ...
                            <div className="flex gap-3">
                                <button
                                    onClick={() => router.push(`/teacher/classes/${classId}/manage-learning`)}
                                    className="px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:from-purple-600 hover:to-indigo-700 shadow-sm flex items-center gap-2 font-medium transition-colors border border-transparent"
                                >
