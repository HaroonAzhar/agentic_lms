    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (userRes.data.role !== 'student' && userRes.data.role !== 'admin') {
                    router.push('/login');
                    return;
                }
                        ...
                        {classes.map((cls) => (
                            ...
                            >
                                ...
                                <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-between items-center">
                                    <span className="text-sm text-blue-600 font-medium group-hover:text-blue-700 transition-colors">Open Class</span>
                                </div>
                            </div>
                        ))}
                    </div>
